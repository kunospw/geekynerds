...
export default function HeroSkeleton() {
  return (
    <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 px-4 md:grid-cols-2 flex-1">
      ...
      <div className="relative h-[520px] md:h-[700px] flex items-center justify-center">
        <div className="relative w-full h-full">
          {[0, 1, 2].map((idx) => {
            ...
            if (idx === 0) {
              // Left book position
              transform = 'translate(-50%, -50%) translateX(-180px) translateY(30px) rotate(-9deg)';
            } else if (idx === 1) {
            ...
            return (
              ...
              >
                <div className="skeleton w-[200px] h-[300px] md:w-[260px] md:h-[400px] rounded-lg"></div>
              </div>
            );
          })}
        </div>
